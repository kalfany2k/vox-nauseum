const UpcomingEvents = () => {
  return (
    <div className="w-[95%] md:w-[80%] h-[80%] flex flex-col drop-shadow-md hover:drop-shadow-xl event-card text-end hover:bg-blue-800/50 transition-all duration-300 ease-in-out overflow-hidden">
